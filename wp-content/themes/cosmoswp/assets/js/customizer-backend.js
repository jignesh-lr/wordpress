...
( function( $ ) {
	...
	wp.customize.bind(
		...
		function() {
			...
			/*Site Identity Sorting and position*/
			wp.customize(
				...
				function( setting ) {
					...
					wp.customize.control( 'site-logo-position', setupControl );
				}
			);
			...
			wp.customize(
				'off-canvas-open-icon-options',
				function( setting ) {
					/*ifSettingTextOrBoth*/
					wp.customize.control(
						'off-canvas-sidebar-open-text',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
			...
			wp.customize(
				'off-canvas-close-icon-options',
				function( setting ) {

					/*ifSettingTextOrBoth*/
					wp.customize.control(
						'off-canvas-sidebar-close-text',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					wp.customize.control(
						'off-canvas-close-text-typography-options',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					...
					/*ifSettingIconOrBoth*/
					wp.customize.control(
						'off-canvas-sidebar-close-icon',
						function(control) {
							ifSettingIconOrBoth( control,setting )
						}
					);
					wp.customize.control(
						'off-canvas-close-icon-size-responsive',
						function(control) {
							ifSettingIconOrBoth( control,setting )
						}
					);
			...
			wp.customize(
				...
				function( setting ) {
					wp.customize.control(
						'off-canvas-close-text-typography',
						function(control) {
							ifSettingCustom( control,setting )
						}
					);
			...
			wp.customize(
				'dropdown-menu-close-icon-options',
				function( setting ) {
					/*ifSettingTextOrBoth*/
					wp.customize.control(
						'dropdown-menu-close-text',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					...
					/*ifSettingBoth*/
					wp.customize.control(
						'dropdown-menu-close-icon-position',
						function(control) {
							ifSettingBoth( control,setting )
						}
					);
			...
			/*popup sidebar*/
			wp.customize(
				'popup-sidebar-open-icon-options',
				function( setting ) {
					/*ifSettingTextOrBoth*/
					wp.customize.control(
						'popup-sidebar-open-text',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					...
					/*ifSettingBoth*/
					wp.customize.control(
						'popup-sidebar-open-icon-position',
						function(control) {
							ifSettingBoth( control,setting )
						}
					);
			...
			/*popup close sidebar*/
			wp.customize(
				'popup-sidebar-close-icon-options',
				function( setting ) {
					/*ifSettingTextOrBoth*/
					wp.customize.control(
						'popup-sidebar-close-text',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					wp.customize.control(
						'popup-close-text-typography-options',
						function(control) {
							ifSettingTextOrBoth( control,setting )
						}
					);
					...
					/*ifSettingBoth*/
					wp.customize.control(
						'popup-sidebar-close-icon-position',
						function(control) {
							ifSettingBoth( control,setting )
						}
					);
			...
			customize_theme_controls.on(
				'change',
				'#_customize-input-header-position-options, #_customize-input-sticky-header-options, #_customize-input-enable-sticky-header-color-options',
				function(e){
					e.preventDefault();
			...
			wp.customize(
				'footer-bottom-widget-title-typography-options',
				function( setting ) {
					wp.customize.control(
			...
			wp.customize(
				'footer-bottom-widget-content-typography-options',
				function( setting ) {
					wp.customize.control(
			...
			function footerWidgetOptions(){
				wp.customize(
					'footer-sidebar-1-widget-setting-option',
					function( setting ) {
						wp.customize.control(
				...
				wp.customize(
					'footer-sidebar-3-widget-setting-option',
					function( setting ) {
						wp.customize.control(
				...
				wp.customize(
					'footer-sidebar-5-widget-setting-option',
					function( setting ) {
						wp.customize.control(
				...
				wp.customize(
					'footer-sidebar-6-widget-setting-option',
					function( setting ) {
						wp.customize.control(
				...
				wp.customize(
					'footer-sidebar-7-widget-setting-option',
					function( setting ) {
						wp.customize.control(
				...
				wp.customize(
					'footer-sidebar-8-widget-setting-option',
					function( setting ) {
						wp.customize.control(
			...
			wp.customize.state( 'expandedPanel' ).bind(
			...
			customize_theme_controls.on(
				'change',
				'#_customize-input-banner-section-display, #_customize-input-single-banner-section-title',
				function(e){
					e.preventDefault();
			...
			/*Location save on custom menu*/
			wp.customize(
				'primary-menu-custom-menu',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'nav_menu_locations[header-primary-menu]' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				...
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'nav_menu_locations[header-secondary-menu]' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				...
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'nav_menu_locations[footer-menu]' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				...
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'nav_menu_locations[dropdown-menu]' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				'sticky-footer-menu-custom-menu',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'nav_menu_locations[sticky-footer-menu]' ).setting.set( value );
					} );
				}
			);
			/*From menu location to customizer select*/
			wp.customize(
				'nav_menu_locations[header-primary-menu]',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'primary-menu-custom-menu' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				'nav_menu_locations[header-secondary-menu]',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'secondary-menu-custom-menu' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				...
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'footer-menu-custom-menu' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				'nav_menu_locations[dropdown-menu]',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'dropdown-menu-custom-menu' ).setting.set( value );
					} );
				}
			);
			wp.customize(
				'nav_menu_locations[sticky-footer-menu]',
				function( setting ) {
					setting.bind( function onChange( value ) {
						wp.customize.control( 'sticky-footer-menu-custom-menu' ).setting.set( value );
					} );
				}
			);
		}
