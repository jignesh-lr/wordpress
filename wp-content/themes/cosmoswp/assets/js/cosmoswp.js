...
jQuery(document).ready(function($){
        ...
        if (cwp_body.hasClass('cwp-sticky-footer')) {
            ...
            if (cwp_window.width() > 768) {
                let footer_height               = footer_main.innerHeight(),
                    fixed_footer_cwp_trigger_height = $('.cwp-sticky-footer-wrapper').innerHeight();
    ...
    if (locationHash !== "" && document.getElementById( locationHash.substring(1, locationHash.length)  ) ) {
