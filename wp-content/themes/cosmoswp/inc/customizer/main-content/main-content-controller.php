	...
	class CosmosWP_Main_Content_Controller {
		...
		public function defaults( $default_options = array() ) {
			...
			$defaults = array(
				...
				'main-content-general-margin'             => json_encode(
					array(
						'desktop' => array(
							'top'         => '',
							'right'       => '',
				...
				'main-content-general-background-options' => json_encode(
					array(
				...
				'main-content-general-border-styling'     => json_encode(
					array(
						'border-style'     => 'none',
						'border-color'     => '',
						'box-shadow-color' => '',
				...
				'banner-section-background-image-options' => json_encode(
					array(
				...
				'cosmoswp-banner-height'                  => json_encode(
					array(
						'desktop' => '500',
						'tablet'  => '350',
						'mobile'  => '200',
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->add_panel(
				cosmoswp_main_content_controller()->panel,
				array(
			...
			$wp_customize->add_section(
				cosmoswp_main_content_controller()->section,
				array(
