...
$wp_customize->add_setting(
    ...
    array(
        'sanitize_callback' => 'cosmoswp_sanitize_slider_width_field',
        'default'           => $header_defaults['menu-icon-sidebar-width'],
        'transport'         => 'postMessage',
    )
);
$wp_customize->add_control(
    new CosmosWP_Custom_Control_Slider(
        ...
        array(
            ...
            'section'         =>  'cosmoswp_header_sidebar',
            'settings'        => 'menu-icon-sidebar-width',
            'input_attrs'     => array(
                'min'  => 0,
                'max'  => 2000,
                'step' => 1,
