...
if ( ! empty( $tablet_icon_size ) ) {
	...
	if ( 'icon' == $scoll_top_icon_options ) {
		$scroll_top_button_tablet_css .= 'line-height:' . $tablet_icon_size . 'px;';
	}
}
// mobile icon size
...
if ( ! empty( $mobile_icon_size ) ) {
	...
	if ( 'icon' == $scoll_top_icon_options ) {
		$scroll_top_button_css .= 'line-height:' . $mobile_icon_size . 'px;';
	}
}
...
if ( $scroll_top_button_css !== 'none' ) {
	...
	//border width
	$scroll_top_icon_border_width = isset( $scroll_top_icon_styling['normal-border-width'] ) ? cosmoswp_cssbox_values_inline( $scroll_top_icon_styling['normal-border-width'], 'desktop' ): false;
