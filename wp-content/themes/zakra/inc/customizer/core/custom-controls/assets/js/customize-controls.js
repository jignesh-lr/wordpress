...
/* global wp, jQuery, _, zakraCustomizerControlGradient */
/**
 * Gradient control JS to handle the background customize option.
 *
 * File `gradient.js`.
 *
 */
    ...
    function ( $ ) {
        ...
        wp.customize.controlConstructor[ 'zakra-gradient' ] = wp.customize.Control.extend( {
            ready() {
                'use strict';
                var control = this;
                control.initFirstColorControl();
                control.initSecondColorControl();
                control.initFirstRangeControl();
                control.initSecondRangeControl();
                ...
                control.container.on( 'change', '.types select', function () {
                    ...
                    control.saveValue( 'type', jQuery( '.types select' ).val() );
                } );
                control.initAngleRangeControl();
                control.container.on( 'change', '.type-radial select', function () {
                    control.saveValue( 'position', jQuery( '.type-radial select' ).val() );
                } );
            },
            initFirstColorControl() {

                'use strict';

                var control = this,
                    isHueSlider = ( this.params.mode === 'hue' ),
                    picker = this.container.find( '.color .zakra-color-picker-alpha' ),
                    color = picker.val().replace( /\s+/g, '' );
            ...
            initSecondColorControl() {

                'use strict';

                var control = this,
                    isHueSlider = ( this.params.mode === 'hue' ),
                    picker = this.container.find( '.second-color .zakra-color-picker-alpha' ),
                    color = picker.val().replace( /\s+/g, '' );
            ...
            initFirstRangeControl() {
                var control = this;

                // Update the text value.
                this.container.find( '.color input[type=range]' ).on( 'input change', function () {
                    var value1        = jQuery( this ).val(),
                        input_number = jQuery( this ).closest( '.slider-wrapper' ).find( '.zakra-range-value .value' );

                    input_number.val( value1 );
                    input_number.change();
                } );

                // Handle the reset button.
                this.container.find( '.color .zakra-slider-reset' ).click( function () {
                ...
                // Save changes.
                this.container.on( 'input change', '.color input[type=number]', function () {
                    var value1 = jQuery( this ).val();
                    jQuery( this ).closest( '.slider-wrapper' ).find( 'input[type=range]' ).val( value1 );
                    control.setting.set( value1 );
                } );
            },

            initSecondRangeControl() {
                var control = this;

                // Update the text value.
                this.container.find( '.second-color input[type=range]' ).on( 'input change', function () {
                ...
                // Handle the reset button.
                this.container.find( '.second-color .zakra-slider-reset' ).click( function () {
                    var wrapper       = jQuery( this ).closest( '.slider-wrapper' ),
                        input_range   = wrapper.find( 'input[type=range]' ),
                        input_number  = wrapper.find( '.zakra-range-value .value' ),
                        default_value = input_range.data( 'reset_value' );
                ...
                // Save changes.
                this.container.on( 'input change', '.second-color input[type=number]', function () {
                    var value = jQuery( this ).val();
            ...
            initAngleRangeControl() {
                var control = this;

                // Update the text value.
                this.container.find( '.type input[type=range]' ).on( 'input change', function () {
                    var value        = jQuery( this ).val(),
                        input_number = jQuery( this ).closest( '.slider-wrapper' ).find( '.zakra-range-value .value' );
                ...
                // Handle the reset button.
                this.container.find( '.type .zakra-slider-reset' ).click( function () {
                    var wrapper       = jQuery( this ).closest( '.slider-wrapper' ),
                        input_range   = wrapper.find( 'input[type=range]' ),
                        input_number  = wrapper.find( '.zakra-range-value .value' ),
                        default_value = input_range.data( 'reset_value' );
                ...
                // Save changes.
                this.container.on( 'input change', '.type input[type=number]', function () {
                    var value = jQuery( this ).val();
                    jQuery( this ).closest( '.slider-wrapper' ).find( 'input[type=range]' ).val( value );
                    control.setting.set( value );
                } );
